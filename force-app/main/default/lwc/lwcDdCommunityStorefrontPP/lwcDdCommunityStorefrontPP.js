...
export default class LwcDdCommunityStorefrontPP extends LightningElement {
    @track language = "en_US";
    @track businessName = "";
    @track businessNameRaw = "";
    @track contactInfo = "";
    @track businessNameRaw = "";
    @track termsConditionLink = "";
    ...
    connectedCallback() {
        ...
        this.termsConditionLink = "/consumers/s/storefront-terms-and-conditions" 
