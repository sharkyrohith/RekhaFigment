...
import getRealTimeAlertsForCase from '@salesforce/apex/RealTimeAlertsController.getRealTimeAlertsForCase';
...
const ELE_NOTICE = '[data-id="Case_Alerts"]';
const ERROR = 'Error';
...
export default class RealTimeAlerts extends LightningElement {
    ...
    *****************************************************************************************************************************/
    ...
    @wire(getRealTimeAlertsForCase,{accountId:'$accountId'})
    wiredGetRealTimeAlertsForCase(result) {
