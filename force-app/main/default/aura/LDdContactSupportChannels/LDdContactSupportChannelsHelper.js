({
	getStat : function(component, helper) {
        ...
        var webForm = helper.findGetParameter("webform");
        if (webForm == "true"){
            component.set("v.webForm", true);
        }
        ...
        action.setCallback(this, function(response) {
            ...
            if (state === "SUCCESS") {
                ...
                component.set("v.currentFive9WaitTime", res.Five9WaitTime);
                component.set("v.currentLiveAgentWaitTime", res.LiveAgentWaitTime);
            }
            else if (state === "ERROR") {
